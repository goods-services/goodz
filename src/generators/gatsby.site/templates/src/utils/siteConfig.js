module.exports = {
  siteTitle: 'Goods & Services',
  siteTitleAlt: 'Goods & Services', // This allows an alternative site title for SEO schema.
  publisher: 'Goods & Services LLC.', // Organization name used for SEO schema
  siteDescription: 'Goods & Services LLC',
  siteUrl: '', // Site domain. Do not include a trailing slash! If you wish to use a path prefix you can read more about that here: https://www.gatsbyjs.org/docs/path-prefix/
